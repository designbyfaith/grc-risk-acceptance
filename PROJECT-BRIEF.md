> **Credit:** This project brief and the template in `templates/` come from the GRC Portfolio 2026 materials published by GitHub user [taimurijlal](https://github.com/taimurijlal), shared under the MIT License as stated in the original. They are included here for reference. The scenario, analysis, and deliverables in this repository are my own work.
